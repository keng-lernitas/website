            ...
            {[...Array(BASE_SIZE - i)].map((_, j) => (
              ...
              >
                <img
                  ...
                  className="absolute left-0 top-0 h-full w-full scale-50 select-none transition-all  [filter:_drop-shadow(0.3rem_0.5rem_0px_#5b4328)]   group-hover:left-[17%] group-hover:top-[-30%] group-hover:scale-100"
                  draggable={false}
                />
                <img
